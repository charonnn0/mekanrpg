...
function build_movementScreen()
	...
	gui["btnCancel"] = guiCreateButton(70, 205, 61, 23, "İptal", false, gui["_root"])
	gui["btnSave"] = guiCreateButton(130, 205, 61, 23, "Kaydet", false, gui["_root"])
...
function build_optionScreen()
	...
	gui["chkbyGatePassword"] =
		guiCreateRadioButton(10, 55, 201, 17, "Opening by command with password", false, gui["_root"])
	...
	gui["btnSave"] = guiCreateButton(110, 325, 101, 23, "Kaydet", false, gui["_root"])
	gui["btnCancel"] = guiCreateButton(10, 325, 101, 23, "İptal", false, gui["_root"])
