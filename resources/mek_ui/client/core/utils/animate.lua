...
function animate(key, data, duration, animateType)
	...
	local a, b, c = interpolateBetween(
		animateData[sourceResource][key]["from"][1],
		animateData[sourceResource][key]["from"][2],
		animateData[sourceResource][key]["from"][3],
		animateData[sourceResource][key]["to"][1],
		animateData[sourceResource][key]["to"][2],
		animateData[sourceResource][key]["to"][3],
		progress,
		animateType
	)
