...
local fonts = {
	...
	FontAwesome = "ttf",
	FontAwesomeBrand = "ttf",
	FontAwesomeRegular = "otf",
	License = "ttf",
	Pricedown = "ttf",
	ProximaNovaBlack = "ttf",
	ProximaNovaBold = "ttf",
	ProximaNovaLight = "ttf",
	ProximaNovaMedium = "ttf",
...
function initializeFonts()
	for name, ext in pairs(fonts) do
		...
		for key, size in pairs(sizes) do
			local fontElement = dxCreateFont(path, size) or "default"
			if fontElement then
	...
	fontElements.icon = dxCreateFont("public/fonts/FontAwesome.ttf", 20) or "default"
end
initializeFonts()
