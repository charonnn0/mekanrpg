function sendReadyMessage()
	triggerServerEvent("bones.requestAttachmentData", root)
end
...
addEvent("bones.sendAttachmentData", true)
addEventHandler("bones.sendAttachmentData", root, getAttachmentData)

function initAttach()
	addEvent("bones.attach", true)
	addEvent("bones.detach", true)
	addEventHandler("bones.attach", root, attachElementToBone)
	addEventHandler("bones.detach", root, detachElementFromBone)
end
