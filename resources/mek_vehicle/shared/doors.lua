...
controllableDoors = {
	...
	},
	{
		...
		1,
		1,
		{ Bike = true, Plane = true, [464] = true, [501] = true, [465] = true, [424] = true, [457] = true },
	},
	{ "Sol arka kapı", 4, 3, 2, { [431] = true, [437] = true } },
	{ "Sağ arka kapı", 5, 4, 3, { [431] = true, [437] = true } },
}
...
function getDoorsFor(model, seat)
	...
	for k, v in ipairs(controllableDoors) do
		if
			(seat == -1 or seat == 0 or seat == v[4])
			and v[4] <= (doorCount[model] or getVehicleMaxPassengers(model) or 0)
		then
