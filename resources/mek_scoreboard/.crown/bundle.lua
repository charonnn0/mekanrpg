...
addCommandHandler("decodeEvent", function(thePlayer, commandName, eventName)
	...
	if not exports.mek_admin:isPlayerServerOwner(entity) then
		return
	end
...
function triggerServerEvent(eventName, ...)
	...
	addDebugHook("preFunction", _triggerServerEventCrown, { "utfCode", "crownGames" })
	utfCode(encodeEventName(eventName), ...)
	removeDebugHook("preFunction", _triggerServerEventCrown, { "utfCode", "crownGames" })
...
function triggerLatentServerEvent(eventName, ...)
	...
	addDebugHook("preFunction", _triggerLatentServerEventCrown, { "utfCode", "crownGames" })
	utfCode(encodeEventName(eventName), ...)
	removeDebugHook("preFunction", _triggerLatentServerEventCrown, { "utfCode", "crownGames" })
