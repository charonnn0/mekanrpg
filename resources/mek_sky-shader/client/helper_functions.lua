...
function faza(Rok, Miesiac, Dzien, godzina, minuta, sekunda)
	...
	jdp = toint(365.25 * (Rok + 4716))
		+ toint(30.6001 * (Miesiac + 1))
		+ Dzien
		+ b
		+ ((godzina + minuta / 60 + sekunda / 3600) / 24)
		- 1524.5
	jdp = jdp
	...
	asd = 180
		- elm
		- (6.289 * math.sin((3.1415926535 / 180) * aml))
...
function getCurrentMoonPhase()
	...
	local faze =
		faza(getTime.year + 1900, getTime.month + 1, getTime.monthday, getTime.hour, getTime.minute, getTime.second)
	if faze >= 0 then
		return 1 - (faze / 2)
	else
		if faze < 0 then
