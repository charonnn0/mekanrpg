...
local fontsSource = {
	...
	["sertfont"] = "files/sertfont.ttf",
	["default"] = "files/default.otf",
	
    ["Sweet"] = "files/Sweet.ttf",
	["avalon"] = "files/avalon.ttf",
    ["avalon-bold"] = "files/avalon-bold.ttf",
    ["ProximaNova"] = "files/ProximaNova.otf",
    ...
    ["ProximaNovaBold"] = "files/ProximaNovaBold.ttf",
    ["ProximaNovaRegular"] = "files/ProximaNovaRegular.ttf",
    ["ProximaNovaLight"] = "files/ProximaNovaLight.ttf",
    ["ProximaNovaMedium"] = "files/ProximaNovaMedium.ttf",
    ...
    ["IckyticketMono"] = "files/IckyticketMono.ttf",
    ["Impact"] = "files/Impact.ttf",
    ["Pixellari"] = "files/Pixellari.ttf",
